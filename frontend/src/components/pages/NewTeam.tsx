...
import { TextField, TextFieldLabel, TextFieldInput } from "../ui/text-field.tsx"
  ...
  return (
    <>
      ...
      <div>
        ...
        <div>
            <h2>Csapattagok: </h2>
            <TextField class="grid" value={teamMateOneName()} onChange={setTeamMateOneName}>
            ...
            <TextField class="grid" value={teamMateSecondName()} onChange={setTeamMateSecondName}>
              <TextFieldLabel>Második csapattag neve: </TextFieldLabel>
              <TextFieldInput type="text" name="teamMateSecondName"></TextFieldInput>
            </TextField>
            <TextField onChange={setTeamMateSecondGrade}>
              <TextFieldLabel>Második csapattag osztálya: </TextFieldLabel>
              <TextFieldInput type="number" min={1} max={13}></TextFieldInput>
            </TextField>
            <TextField class="grid" value={teamMateThirdName()} onChange={setTeamMateThirdName}>
              <TextFieldLabel>Harmadik csapattag neve: </TextFieldLabel>
              <TextFieldInput type="text" name="teamMateThirdName"></TextFieldInput>
            </TextField>
            <TextField onChange={setTeamMateThirdGrade}>
              <TextFieldLabel>Harmadik csapattag osztálya: </TextFieldLabel>
              <TextFieldInput type="number" min={1} max={13}></TextFieldInput>
            </TextField>
            <TextField class="grid" value={substituteTeamMateName()} onChange={setSubstitudeTeamMateName}>
              <TextFieldLabel>Pót csapattag neve: </TextFieldLabel>
              <TextFieldInput type="text" name="substitudeTeamMateName"></TextFieldInput>
            </TextField>
        ...
        <Combobox options={ALL_SHOOL} placeholder="Válassz egy iskolát" itemComponent={props => (
            <Combobox.Item item={props.item} class="transition-colors duration-20000 hover:bg-blue-950">
      ...
      <Combobox options={ALL_CATEGORY} placeholder="Válassz egy kategóriát" itemComponent={props => (
            <Combobox.Item item={props.item} class="transition-colors duration-20000 hover:bg-blue-950">
            <Combobox.ItemLabel>{props.item.rawValue}</Combobox.ItemLabel>
            <Combobox.ItemIndicator />
            </Combobox.Item>  
      ...
      <Combobox options={ALL_PROGRAMMING_LANGS} placeholder="Válassz egy programnyelvet" itemComponent={props => (
            <Combobox.Item item={props.item} class="transition-colors duration-20000 hover:bg-blue-950">
            <Combobox.ItemLabel>{props.item.rawValue}</Combobox.ItemLabel>
            <Combobox.ItemIndicator />
            </Combobox.Item>  
